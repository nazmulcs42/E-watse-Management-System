...
Route::get('/userlayouts', function () {
    return view('layouts.userlayouts');
});
Route::get('/collectorlayouts', function () {
    return view('collector');
});

//user login-logout
Route::get('/index', 'UserInfoController@index')->name('user.index');


Route::get('/', 'UserInfoController@homepage')->name('user.homepage');

Route::get('/userprofile/', 'UserInfoController@edit')->name('user.userprofile');
//Route::get('/userprofile/', 'UserInfoController@edit')->name('user.userprofile');

Route::get('/userlogin', 'UserInfoController@userlogin')->name('user.userlogin');
Route::get('/userregister', 'UserInfoController@userregister')->name('user.userregister');
...
// path create between the nodes and reload into the map
Route::get('/path/input', 'PathController@create')->name('path.input');
Route::post('/path/input/submit', 'PathController@store')->name('path.input.submit');
Route::get('/path/output', 'PathController@show')->name('path.output');//shown in map format

//node create and reload into map
Route::get('/house/input', 'HouseController@create')->name('house.input');
Route::post('/house/input/submit', 'HouseController@store')->name('house.input.submit');
Route::get('/house/output', 'HouseController@show')->name('house.output');//shown in map format
Route::get('/house', 'HouseController@index')->name('house'); //show in table format
