<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img alt="CoreUI Logo" class="navbar-brand-full" height="25" src="frontendDashboard/img/brand/logo.svg" width="89">
            <img alt="CoreUI Logo" class="navbar-brand-minimized" height="30" src="frontendDashboard/img/brand/sygnet.svg" width="30">
            </img>
        </img>
    </a>
    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a aria-expanded="false" aria-haspopup="true" class="nav-link" data-toggle="dropdown" href="#" role="button">
                <img alt="admin@bootstrapmaster.com" class="img-avatar" src="frontendDashboard/img/avatars/6.jpg">
                </img>
            </a>
